...
import bookPreviewImage from "../images/bookOfWeek5.jpg";

function BookDetailPage_abyss() {
  const scrollToTop = () => {
    window.scrollTo({
      top: 0,
      behavior: "smooth",
            ...
            <div className="header-contents-inner">
              <div className="prod-detail-title-wrap">
                <div className="prod-title-area">
                  <div className="prod-title-box">심연</div>
                ...
                <div className="prod-detail-area book-intro">
                  ...
                  <div className="intro-bottom">
                    <div className="info-text">
                      역사와 초자연적 현상을 결합한 환상소설로 미국 평단과
                      대중의 주목을 받아온 작가 앨마 카츠의 미스터리 소설.
                      서스펜스 심리 스릴러와 고딕 유령 이야기의 완벽한 결합이라
                      할 수 있는 이 소설은 1912년 침몰한 호화 유람선
                      타이태닉호와 4년 후 1차 세계대전 중 침몰한 자매선
                      브리태닉호의 실화를 바탕으로, 두 배에 모두 탑승한 실존
                      인물에게서 모티프를 따온 주인공을 통해 그 이면의 이야기를
                      다룬다. 1912년과 1916년의 상황을 교차해 보여주는 형식을
                      띠는 이 소설은 초반에 여러 등장인물이 교대로 등장해(실존
                      인물과 허구적 인물이 섞여 있다) 배에 나타나는 불길한
                      징조들을 각자의 시점으로 바라본다. 중반에 이르면서는 화자
                      중 한 명인 주인공 애니 헤블리의 내면으로 깊숙이 들어가
                      자신의 정체에 혼란을 느끼는 그녀의 불안한 시선으로
                      주변에서 일어나는 기이한 사건들을 묘사한다.
                      <br></br>
                      이는 극도로 불안하게 흔들리는 애니의 심리를 따라 이야기를
                      쫓아가는 독자에게 묘한 긴장감과 불안감을 느끼게 할 뿐
                      아니라, 이어질 사건들에 대한 기대에 따른 깊은 몰입감을
                      선사한다. 여기에 바다의 여신 더바사나 바꿔친 아이 같은
                      아일랜드 설화가 버무려져 신비로운 분위기를 더한다.
                      <br></br>
                      독자는 섬뜩하고 불길한 느낌과 함께 조금씩 실마리가
                      풀려나가는 이야기를 따라가다 마지막 부분에 가서 두 침몰
                      사고의 충격적인 소설적 진실에 맞닥뜨리게 된다. 작가가
                      장치해놓았던 단서들이 하나둘씩 떠오르고 거대한 수수께끼의
                      퍼즐이 맞춰지는 오싹한 기분, 독자는 이 매혹적인 소설의 첫
                      장으로 되돌아가게 될 것이다.
                    </div>
                  </div>
                    ...
                    <div className="gray-box">
                      <div className="title-wrap title-size-def">
                        <h3 className="title-heading">
                          ...
                          <span className="text">앨마 카츠</span>
                        </h3>
                      </div>
                    </div>
                  </div>
                        ...
                        <ul className="basic-info-list">
                          <li className="basic-info-item">
                            ...
                            <p className="info-item-text">
                              9791167901514 ( 1167901517 )
                            </p>
                          </li>
                          <li className="basic-info-item">
                            <p className="info-item-title">발행(출시)일자</p>
                            <p className="info-item-text">2023년 01월 13일</p>
                          </li>
                          <li className="basic-info-item">
                            <p className="info-item-title">쪽수</p>
                            <p className="info-item-text">604쪽</p>
                          </li>
                          <li className="basic-info-item">
...
export default BookDetailPage_abyss;
